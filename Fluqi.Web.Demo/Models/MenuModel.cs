...
namespace Fluqi.Models
{
	...
	public class MenuModel: BaseModel {
		...
		public void ConfigureMenu(Menu mnu) {
			mnu
				.Items()
					.Add("Home", "http://fluqi.apphb.com")
						.Configure()
							.SetIcon(Core.Icons.eIconClass.home)
						.Finish()
					.Add("File").Configure().SetIcon(Core.Icons.eIconClass.disk).Finish()
						.SubMenu()
							.Add("Open").Configure().SetIcon(Core.Icons.eIconClass.folder_open).Finish()
							.Add("Search").Configure().SetIcon(Core.Icons.eIconClass.search).Finish()
							.Add("Close").Configure().SetIcon(Core.Icons.eIconClass.close).Finish()
						.Back()
					.Add("Edit").Configure().SetIcon(Core.Icons.eIconClass.pencil).Finish()
						.SubMenu()
							.Add("Cut").Configure().SetIcon(Core.Icons.eIconClass.scissors).Finish()
							.Add("Copy").Configure().SetIcon(Core.Icons.eIconClass.copy).Finish()
							.Add("Paste").Configure().SetIcon(Core.Icons.eIconClass.pause).Finish()
						.Back()
				.Finish()
				.Rendering

...
namespace Fluqi.Utilities.jAnimation
{
	...
	public class Rendering: Core.RenderBase {
		...
		public Rendering(Animation animation)
		 : base()
		{
		...
		/// returns the <see cref="Animation"/> object so we can continue defining Animation attributes.
		/// </summary>
		/// <returns>Returns <see cref="Animation"/> object to return chaining to the Animation collection</returns>

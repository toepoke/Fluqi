...
namespace Fluqi.Utilities.jPosition
{
	...
	public class Rendering: Core.RenderBase {
		...
		/// returns the <see cref="Position"/> object so we can continue defining Position attributes.
		/// </summary>
		/// <returns>Returns <see cref="Position"/> object to return chaining to the Position collection</returns>

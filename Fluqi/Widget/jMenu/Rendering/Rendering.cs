...
namespace Fluqi.Widget.jMenu
{
	...
	public class Rendering: Core.RenderBase {
		...
		/// returns the <see cref="Menu"/> object so we can continue defining Menu attributes.
		/// </summary>
		/// <returns>Returns <see cref="Menu"/> object to return chaining to the Menu collection</returns>
		public Menu Finish() {
			return this.Menu;
		}

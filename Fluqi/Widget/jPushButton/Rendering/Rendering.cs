...
namespace Fluqi.Widget.jPushButton
{
	...
	public class Rendering: Core.RenderBase {
		...
		/// returns the <see cref="PushButton"/> object so we can continue defining Button attributes.
		/// </summary>
		/// <returns>Returns <see cref="PushButton"/> object to return chaining to the Button collection</returns>

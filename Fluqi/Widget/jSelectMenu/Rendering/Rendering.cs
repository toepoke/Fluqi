...
namespace Fluqi.Widget.jSelectMenu
{
	...
	public class Rendering: Core.RenderBase {
		...
		/// returns the <see cref="SelectMenu"/> object so we can continue defining SelectMenu attributes.
		/// </summary>
		/// <returns>Returns <see cref="SelectMenu"/> object to return chaining to the SelectMenu collection</returns>

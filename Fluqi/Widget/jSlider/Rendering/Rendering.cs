...
namespace Fluqi.Widget.jSlider
{
	...
	public class Rendering: Core.RenderBase {
		...
		/// returns the <see cref="Slider"/> object so we can continue defining Slider attributes.
		/// </summary>
		/// <returns>Returns <see cref="Slider"/> object to return chaining to the Slider collection</returns>

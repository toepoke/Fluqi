...
namespace Fluqi.Widget.jSpinner
{
	...
	public class Rendering: Core.RenderBase {
		...
		public Rendering(Spinner spinner)
		 : base()
		{
		...
		/// returns the <see cref="Spinner"/> object so we can continue defining Spinner attributes.
		/// </summary>
		/// <returns>Returns <see cref="Spinner"/> object to return chaining to the Spinner collection</returns>
